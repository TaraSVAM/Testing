...
//
//			Map<String, Object> chromeNew = new HashMap<String, Object>();
//			chromeNew.put("mobileEmulation",mobileEmulation);
			dc = DesiredCapabilities.chrome();
			ChromeOptions options = new ChromeOptions();
			options.addArguments("disable-infobars");
			options.addArguments("--disable-notifications");
//			String _userName = config.getPropertyValue("SYSTEMUSERNAME");
//			_userName = "user-data-dir=C:/Users/" + _userName + "/AppData/Local/Google/Chrome/User Data";
//			options.addArguments(_userName);
			options.addArguments("--start-maximized");
			options.addArguments("test-type");
			dc.setBrowserName(BrowserType.CHROME);
			dc.setCapability(ChromeOptions.CAPABILITY, options);
			//dc.setCapability(ChromeOptions.CAPABILITY, chromeNew);
	...
	public static WebDriver createDriverInstance(BrowserTypes browserType, String driverPath) throws Exception {
		...
		System.out.println("createDriverInstance " + browserType);
		System.out.println("DesiredCapabilities " + dc);
		switch (browserType) {
		case FIREFOX:
	...
	public static void openNewTab() {
		try {
			...
			LOGGER.error("Unable to Open New Tab", e);
		}
	...
	public static void selectValue(WebDriver driver, By by, String optionText) {
		...
		if (optionText.toLowerCase().startsWith("index=")) {
			...
			if (captureInReport == "Yes")
				ExtentManager.extentTest.log(LogStatus.INFO,
						"Selecting text from dropdown '" + optionText.replaceAll("containstext=", "") + "'");
		} else if (optionText.startsWith("value=")) {
			selectValue(driver, by, "value", optionText.replaceAll("value=", ""));
			if (captureInReport == "Yes")
				ExtentManager.extentTest.log(LogStatus.INFO,
						"Selecting text from dropdown '" + optionText.replaceAll("value=", "") + "'");
		} else {
	...
	public static void inputText(WebDriver driver, By by, String data) throws Exception {
		...
		String captureInReport = config.getPropertyValue("TrackInReport");
		if (captureInReport == "Yes")
			ExtentManager.extentTest.log(LogStatus.INFO, "Entering value '" + data + "'");
	}
	...
	public static void attachScreenShot(ExtentTest extentTest, String description, boolean status) {
		String screenShotPath = new File("Framework\\Test_Reports\\Screenshots\\ ").getAbsolutePath() + description
		...
		if (status)
			extentTest.log(LogStatus.PASS, description + "-Passed" + extentTest.addScreenCapture(screenShotPath));
		else
			extentTest.log(LogStatus.FAIL, description + "-Failed" + extentTest.addScreenCapture(screenShotPath));
